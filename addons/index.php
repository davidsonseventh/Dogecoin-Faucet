...
if($user){
	...
	$content .= "<a href='https://ouo.io/YTnqUP' class='btn btn-primary'>Account/Stats/Withdraw</a><br /><br />";
	...
	if(!$faucetpayApiToken AND !$blockioApiKey AND $expressCryptoApiToken){
		...
		$textForm = "Dogecoin Address or EC UserID";
	} else {
		$providerWithdr['btc'] = true;
		$providerWithdr['ec'] = false;

		$textForm = "Dogecoin Address";
	}
